...
a client. We've tried to address all obvious needs. Here's what a more typical
server would look like:[1]

<pre class="sh_ruby"><code title="A more realistic server">
  client do 
    channel = Cod.tcp('127.0.0.1:12345')
    channel.interact :ehlo # => 
    channel.interact :bark # => 
